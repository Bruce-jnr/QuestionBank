...
function parseMultipartFormData(req, { persistFiles = true } = {}) {
      ...
      try {
        ...
        for (let partBuffer of parts) {
          ...
          if (filenameMatch) {
            ...
            if (!detectedType) {
              const error = new Error(
                'File contents are not a supported JPEG, PNG, GIF, or WebP image',
              );
            ...
            files[fieldName] = {
              ...
              buffer: persistFiles ? undefined : cleanBody,
            };
          } else {
